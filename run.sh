...
ros2 run ros2_orbslam3 rgbd "$ORB_SLAM3_DIR/Vocabulary/ORBvoc.txt" "$ORB_SLAM3_DIR/Examples/RGB-D/RealSense_D435i.yaml" --ros-args -r /orbslam3/image_raw:=/camera/color/image_raw -r /orbslam3/image_depth:=/camera/depth/image_rect_raw
